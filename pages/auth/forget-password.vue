...
<div id="content" role="main" class="w-full  max-w-md mx-auto p-6">
    <div class="mt-16 bg-white  rounded-xl shadow-lg dark:bg-gray-800 dark:border-gray-700 border-2 border-indigo-300">
      <div class="p-4 sm:p-7">
        <div class="text-center">
          <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">بازیابی پسورد</h1>
          <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
            رمز عبور رو به خاطر دارید؟
            <nuxt-link class="text-blue-600 decoration-2 hover:underline font-medium" to="/auth/login">
              وارد شوید
            </nuxt-link>
          </p>
        </div>
        ...
        <div class="mt-5">
          <form @submit.prevent="ForgetPassword.ForgetPassword">
            <div class="grid gap-y-4">
              ...
              <button type="submit" class="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800">بازیابی پسورد</button>
            </div>
          </form>
        </div>
      </div>
    ...
    <p class="mt-3 flex justify-center items-center text-center divide-x divide-gray-300 dark:divide-gray-700">
      ...
      <a class="pr-3 inline-flex items-center gap-x-2 text-sm text-gray-600 decoration-2 hover:underline hover:text-blue-600 dark:text-gray-500 dark:hover:text-gray-200" href="#">
